...
Up to this point, this book has focused on practicalities of the data analysis process. How do we work with a data set? How can we summarise it? How do we visualise it? These are among the most important jobs we have to undertake when doing real life data analysis, so I've talked about them a lot. However, statistics is a bigger topic than this. One of the most powerful tools it provides is a method for making *inferences* about data, and using data to making *decisions* in a justifiable manner. 

Suppose you have decided to run a survey to measure community attitudes towards, oh, I don't know... let's make it lizards. Do people in your community like lizards? Conveniently, you happen to have a big database of all the people in your community, ... but alas the population is large and your budget is small. So you select 100 people from the community completely at random and ask them a simple question: "do you like lizards, yes or no?" When you finish this exercise it turns out that 73 people say "yes I like lizards" and 27 people said "no I don't like lizards". Cool, cool.

So now that you have the data, is it reasonable to claim that 73% of community members like lizards? That doesn't sound right, but why not? Well, let's imagine that there are 10000 people this community, but you've only surveyed 100 of them. So there are 9900 people whose opinions you don't know. That's quite a lot of unknowns! It would be quite foolish to claim that the remaining 9900 people are *exactly* like the 100 people you spoke to, and so it would be unreasonable to claim that the correct answer is exactly 73%.

Okay, let's think about it another way. Would it be fair to say that the percentage of people in this community who like lizards is somewhere between 0.73% and 99.73%? Well, yes, technically speaking that's true, but somehow that doesn't feel very satisfying. After all, when you took your survey you observed 73 out of 100 people who like lizards, and the only way that could happen if the true percentate were 0.73% would be if there are *zero* lizard-likers to be found in the entirety of the 9900 people you didn't survey. Somehow, in your random sample of 100 people you managed to find *every single person* who likes lizards? That doesn't sound very plausible, does it? 

Intuitively, it seems reasonable to guess that the right answer must be "near(ish) to 73%". As a matter of commonsense reasoning, we would't be surprised if the true answer turned out to be 69% or 80%, but we would be very surprised indeed if the answer was 21%. But exactly *how* surprised should we be? Given the data we have observed, what beliefs should we have about the larger population? What decisions can we justify? It is at this point that our commonsense intuitions start to break down: we need some new tools. 
